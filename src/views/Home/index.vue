            ...
            >
                <template v-slot:home-page-content>
                    ...
                    <ul class="home-part2-content home-part2-icon-list">
                        <li
                            v-for="item in homePartDataLists.homePart2PicDataList"
                            :key="item.id"
                        >
                            <img :src="item.imgUrl" :alt="item.alt" />
                            <div class="home-part2-icon-list-title">
                                {{ item.title }}
                            </div>
        ...
        <div class="part3">
            ...
            >
                <template v-slot:home-page-content>
                    <JerrySwiper
                        :jerrySwiperOption="
                            jerrySwiperOptions.homePart3JerrySwiperOption
                        "
                            ...
                            >
                                ...
                                <div class="home-part3-swiper-describe-box">
                                    <div>
                                        <p
                                            class="
                                                home-part3-swiper-describe-title
                                            "
                                        >
                                            {{ item.describeTitle }}
                                        </p>
                                        ...
                                        <p
                                            class="
                                                home-part3-swiper-describe-img
                                            "
                                        >
                                            <router-link to="/join"
                                                ><img
                                                    src="@/assets/home/part3/arrow_right.png"
                                                    alt=""
                                            /></router-link>
                                        </p>
                                    </div>
            ...
            >
                <template v-slot:home-page-content>
                    <JerrySwiper
                        ...
                        :jerrySwiperOption="
                            jerrySwiperOptions.homePart4JerrySwiperOption
                        "
                    >
                        <template v-slot:jerry-swiper-slides>
        ...
        <div class="part7">
            ...
            >
                <template v-slot:home-page-content>
                    <JerrySwiper
                        :jerrySwiperOption="
                            jerrySwiperOptions.homePart7JerrySwiperOption
                        "
        ...
        <div class="part8">
            ...
            >
                <template v-slot:home-page-content>
                    <div class="part8-box">
                        <div
                            v-for="item in homePartDataLists.homePart8DataList"
                            :key="item.id"
                            class="part8-main-box"
                            :style="{
                                backgroundImage: `url('${item.backgroundImageUrl}')`,
                            }"
                        >
                            <div class="part8-icon-box">
